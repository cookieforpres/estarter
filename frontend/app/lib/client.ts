...
export function Environment(name: string): BaseURL {
    return `https://${name}-my-app-i8n2.encr.app`
}
...
/**
 * Client is an API client for the my-app-i8n2 Encore application. 
 */
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (typeof window === "undefined") {
            this.headers["User-Agent"] = "my-app-i8n2-Generated-TS-Client (Encore/v1.39.3)";
        }
